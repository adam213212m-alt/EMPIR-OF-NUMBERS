    ...
    if request.method == 'POST':
        ...
        if action == 'open_three_boxes':
            ...
            if len(selected_indices) == 3:
                ...
                if bal >= cost:
                    # خصم الدولار فوراً مع بداية المحاولة وقبل إتمام النقرات الثلاث نهائياً
                    cursor.execute("UPDATE users SET balance = balance - ? WHERE username=?", (cost, username))
                    ...
                    # كل ثلاثة أرقام متطابقة أو الوصول للمحاولة 36 تعد محاولة فائزة
...
<body>
    ...
    <div class="boxes-container">
        <h3 style="color: #ffd700; margin-top: 0;">📦 انقر على صندوق واحد لكشف النتيجة وخصم 1$ فورا</h3>
        <p style="color: #cbd5e1; font-size: 15px;">يتم خصم التكلفة وفحص النتيجة مع النقرة الأولى</p>
