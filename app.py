...
def game_number_wheel(): return f"{get_lang_bar()}<div style='text-align:center; padding:50px; color:#fff;'><h2>عجلة الحظ</h2><a href='/dashboard'>🏠 عودة</a></div>"
@app.route('/game_reveal_and_win')
def game_reveal_and_win(): return f"{get_lang_bar()}<div style='text-align:center; padding:50px; color:#fff;'><h2>اكشف واربح</h2><a href='/dashboard'>🏠 عودة</a></div>"
@app.route('/game_arrow_wheel')
def game_arrow_wheel(): return f"{get_lang_bar()}<div style='text-align:center; padding:50px; color:#fff;'><h2>رمي السهم المتحركة</h2><a href='/dashboard'>🏠 عودة</a></div>"
